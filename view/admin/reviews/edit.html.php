...
<div class="widget board">
    <p>
        <?php echo Text::_('Comentario de'); ?> <?php echo $project->user->name; ?>:<br />
    ...
    <form method="post" action="/admin/reviews/<?php echo $this['action']; ?>/<?php echo $project->id; ?>/?filter=<?php echo $this['filter']; ?>">
        ...
        <p>
            <label for="review-to_checker"><?php echo Text::_('Comentario para el revisor'); ?>:</label><br />
            <textarea name="to_checker" id="review-to_checker" cols="60" rows="10"><?php echo $review->to_checker; ?></textarea>
        </p>

        <p>
            <label for="review-to_owner"><?php echo Text::_('Comentario para el productor'); ?>:</label><br />
