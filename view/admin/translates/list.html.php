...
?>
<a href="/admin/translates/add" class="button"><?php echo Text::_('Nuevo proyecto para traducir'); ?></a>

<div class="widget board">
<form id="filter-form" action="/admin/translates" method="get">
    <label for="owner-filter"><?php echo Text::_('Proyectos del usuario'); ?>:</label>
    <select id="owner-filter" name="owner" onchange="document.getElementById('filter-form').submit();">
        <option value=""><?php echo Text::_('Todos los productores'); ?></option>
    ...
    <label for="translator-filter"><?php echo Text::_('Asignados a traductor'); ?>:</label>
    <select id="translator-filter" name="translator" onchange="document.getElementById('filter-form').submit();">
        <option value=""><?php echo Text::_('Todos los traductores'); ?></option>
            ...
            <table>
                <thead>
                    <tr>
                        ...
                        <th width="55%"><?php echo Text::_("Proyecto"); ?></th> <!-- edit -->
                        <th width="30%"><?php echo Text::_("Creador"); ?></th>
                        <th width="10%"><?php echo Text::_('Idioma'); ?></th>
                    </tr>
                </thead>
                ...
                <tbody>
                    ...
                    <tr>
                        <td><a href="/admin/translates/edit/<?php echo $project->id; ?>">[<?php echo Text::_("Editar"); ?>]</a></td>
